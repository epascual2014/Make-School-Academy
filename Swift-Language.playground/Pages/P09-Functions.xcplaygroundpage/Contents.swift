...
// 2
func getPerimeter(height: Int, width: Int) -> Int {
    return height * 2 + width * 2
}

getPerimeter(15, width: 20)

// 3
func getUnusualShape(lengths: [Int]) -> Int {
...
var instructorsNames = ["Dan","Steph","Dion","Mike"]
func findInstructors(prefix: String) -> [String]? {
    var instructorsFound = [String]()
    for teachers in instructorsNames {
        if teachers.hasPrefix(prefix) {
            instructorsFound.append(teachers)
    }
    return instructorsFound
}

print(findInstructors("S"))
