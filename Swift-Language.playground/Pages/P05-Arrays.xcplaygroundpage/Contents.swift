...
var lastItem = mutableGroceryList[1]
...
var myArray = ["wake up","wash the dishes","milke the cows"]

myArray.append("churn butter")
myArray += ["call the cows"]
...
print(myArray[currentTask])

myArray.insert("feed the chickens", atIndex: 1)
currentTask += 1
