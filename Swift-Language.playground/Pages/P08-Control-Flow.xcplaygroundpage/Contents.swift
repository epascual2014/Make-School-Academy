...
var myInstructors = ["Dan", "Mart", "Step", "Ann", "Dion", "Mike"]

for instructor in myInstructors {
    print(myInstructors)
}

// 2
var sortedInstructors = [String]()
for instructor in myInstructors {
    if instructor.hasPrefix("D") {
        sortedInstructors.append(instructor)
    }
}
// 3
