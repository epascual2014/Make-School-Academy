...
let xTrip = Double(endCoord.x) - startCoord.x
let yTrip = Double(endCoord.y) - startCoord.y
let length = sqrt(xTrip * xTrip + yTrip * yTrip)

print(length)

var dollar = (type: "usd", value: 1.0)
var cad = (type: "canada", value: dollar.value * 1.29)

var australian = (type: "aud", value: dollar.value * 1.36)

print("\(dollar.value) \(dollar.type) is \(cad.value) \(cad.type)")
