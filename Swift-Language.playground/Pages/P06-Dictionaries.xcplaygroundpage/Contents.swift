...
instructors["first name"] = "last name"
instructors["first name 2"] = "last name 2"
instructors["first name 3"] = "last name 3"
print(instructors["first name"])

//print(instructors["first name 4"]!)

if instructors["first name 4"] != nil {
    
    print(instructors["first name 4"])
}

var trackInstructors = [String: [String]]()

trackInstructors["apps"] = ["1","2","3"]
trackInstructors["games"] = ["4","5","6"]

if let apps = trackInstructors["apps"] {
